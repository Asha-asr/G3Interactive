...
<div class="modal fade in" id="add-partnumber">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form action="{{url('add-part')}}" method="POST">
        @csrf
        <div class="modal-body pt-0">
          <div class="form-group mb row ml-0">
            <div class="col-md-12">
              <label class=" control-label">Part number</label>
              <input type="number" name="partnumber" class="form-control" placeholder="Part number">
            </div>
          </div>
          <div class="form-group mb row ml-0">
            <div class="col-md-12">
              <label class=" control-label">Description </label>
              <textarea name="partdescription" rows="3" class="form-control" placeholder="Type.."></textarea>
            </div>
          </div>
        </div>
