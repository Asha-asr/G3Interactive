    ...
    <div class="row">
      <div class="col-md-12" style="padding-right: 16px;">
        <div class="pull-right">
          <a href="{{ url('add-job') }}" class="btn btn-sm btn-primary" style="margin-bottom: 5px;">
        ...
        <div class="table-responsive">
         ...
         <tbody>
          <tr>
            ...
            <td>xyz</td>
            <td>Al12554</td> 
            <td><a href="{{ url('add-job') }}"  class="btn btn-xs btn-primary">View</a></td>
          </tr>
          <tr>
            <td>2</td>
            <td>t1255</td>
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content" style="border-top: solid #0f7393 5px;">
      ...
      <div class="modal-footer">
        <a href="{{ url('add-job') }}" class="btn btn-success">Yes</a>
